...
public class ContentController {
    ...
    public ResultBean listContentByType (@RequestBody ContentParams params){
        List<Content> contentList = contentService.listContentByType(params.getType());
        return new ResultBean(contentList, ResultEnum.SUCCESS);
    }

    @ApiOperation(value = "获取全部内容列表",httpMethod = "POST")
    @RequestMapping(value = "listAll",method = RequestMethod.POST)
    public ResultBean listAllContent (@RequestBody ContentParams params){
